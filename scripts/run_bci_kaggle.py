...
# ---------- OPTIONS ----------
PROJECT_STR = "pbt-bci-kaggle"
MODEL_STR = 'BCI_kaggle_1024'
DATASET_STR = 'BCI_kaggle_1024'
DATASET_STR_TEST = 'BCI_kaggle_submit_1024'
RUN_TAG = 'longer'
cpus = 2
...
HYPERPARAM_SPACE = {
    ...
    "model.behavior_readout.dropout_rate": HyperParam(
        0.0, 0.6, explore_wt=0.3, sample_fn="uniform"
    ),
    "model.l2_gen_scale": HyperParam(1e-4, 1e-0, explore_wt=0.3),
    "model.l2_con_scale": HyperParam(1e-4, 1e-0, explore_wt=0.3),
    "model.behavior_weight": HyperParam(5e-2, 1e-0, explore_wt=0.3),
}
# ------------------------------
...
metric = "valid/beh_recon_smth"
# metric = "valid/pbt_target"
num_trials = 16
perturbation_interval = 10
burn_in_period = 20 + 10
# analysis = tune.run(
...
# mandatory_overrides["datamodule"] = DATASET_STR
# run_model(
#     overrides=mandatory_overrides,
#     checkpoint_dir=best_ckpt_dir,
#     config_path="../configs/pbt.yaml",
...
mandatory_overrides["datamodule"] = DATASET_STR_TEST
run_model(
    overrides=mandatory_overrides,
    checkpoint_dir=best_ckpt_dir,
    config_path="../configs/pbt.yaml",
