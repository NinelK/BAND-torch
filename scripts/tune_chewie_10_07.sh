...
# python scripts/run_pbt_defaultHP.py ${model} ${dataset} lfads_both_${fac_dim}f_${co_dim}c_causal_PBT ${T} ${fac_dim} ${co_dim} ${n_all} True
...
# python scripts/run_pbt_defaultHP.py ${model} ${dataset} band_both_${fac_dim}f_${co_dim}c_causal_PBT ${T} ${fac_dim} ${co_dim} ${n_all} True
