...
# ---------- OPTIONS ----------
PROJECT_STR = "pbt"
DATASET_STR = "chewie_10_07"
RUN_TAG = datetime.now().strftime("%y%m%d") + "_band_minloss_noIClen_KL1"
# RUN_TAG = '240517_examplePBT'
...
PROJECT_STR = "pbt"
DATASET_STR = "chewie_10_07"
RUN_TAG = datetime.now().strftime("%y%m%d") + "_lfads_minloss_noIClen_KL1"
# RUN_TAG = '240517_examplePBT'
RUN_DIR = Path("/disk/scratch2/nkudryas/BAND-torch/runs") / PROJECT_STR / DATASET_STR / RUN_TAG
HYPERPARAM_SPACE = {
    "model.lr_init": HyperParam(
