...
from ..band_datamodules import reshuffle_train_valid
from ..band2_tuples import SessionOutput
from ..band_utils import send_batch_to_device, transpose_lists
...
def run_posterior_sampling(model, datamodule, filename, num_samples=50):
    ...
    Parameters
    ----------
    model : band_torch.model.BAND
        A trained BAND model.
